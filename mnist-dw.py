...
class MNIST(data.Dataset):
    ...
    """
    urls = [
        'file:///app/rxy-wrapper/train-images-idx3-ubyte.gz',
        'file:///app/rxy-wrapper/train-labels-idx1-ubyte.gz',
        'file:///app/rxy-wrapper/t10k-images-idx3-ubyte.gz',
        'file:///app/rxy-wrapper/t10k-labels-idx1-ubyte.gz',
    ]
    raw_folder = 'raw'
